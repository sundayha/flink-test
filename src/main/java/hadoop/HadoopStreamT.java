...
public class HadoopStreamT {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Long> ds = executionEnvironment.generateSequence(0, 10000);
        ...
        BucketingSink.createHadoopFileSystem(new Path("hdfs://localhost:9000/home/zb/zhangbo"), configuration);
