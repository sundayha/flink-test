...
// */
//public class TumblingPTimeWindowsTest {
//    /**
...
//        //        return new org.apache.flink.streaming.api.watermark.Watermark(currentMaxTimestamp - delay);
//        //    }
//        //
//        //    @Override
//        //    public long extractTimestamp(Message element, long previousElementTimestamp) {
//        //        long date = element.getDate();
//        //        currentMaxTimestamp = Math.max(date, currentMaxTimestamp);
...
//                });
//
//        //SingleOutputStreamOperator<Long> d = waterMarkDataStream.keyBy("topic")
//        //        .timeWindow(Time.seconds(3))
//        //        .allowedLateness(Time.seconds(5)).reduce(new ReduceFunction<Message>() {
//        //            @Override
//        //            public Message reduce(Message value1, Message value2) throws Exception {
//        //                Message msg = new Message();
//        //                msg.setDate(value1.getDate() + value2.getDate());
//        //                return msg;
//        //            }
//        //        }, new WindowFunction<Message, Long, Tuple, TimeWindow>() {
//        //            @Override
//        //            public void apply(Tuple tuple, TimeWindow window, Iterable<Message> input, Collector<Long> out) throws Exception {
//        //                input.forEach(i -> {
//        //                    out.collect(i.getDate());
//        //                });
//        //            }
//        //        });
//        //
//        //d.print();
//
//        //SingleOutputStreamOperator<Tuple2<String, Double>> d1 = waterMarkDataStream.keyBy("topic").timeWindow(Time.seconds(3)).allowedLateness(Time.seconds(5))
//        //        .aggregate(new AggregateFunction<Message, Tuple2<Long, Long>, Double>() {
//        //            @Override
...
//        //
//        //            @Override
//        //            public Tuple2<Long, Long> add(Message value, Tuple2<Long, Long> accumulator) {
//        //                return new Tuple2<>(accumulator.f0 + 1, value.getDate() + accumulator.f1);
//        //            }
//        //
//        //            @Override
...
//        //            }
//        //        }, new ProcessWindowFunction<Double, Tuple2<String, Double>, Tuple, TimeWindow>() {
//        //            @Override
//        //            public void process(Tuple key, Context context, Iterable<Double> elements, Collector<Tuple2<String, Double>> out) throws Exception {
//        //                Double avg = elements.iterator().next();
//        //                out.collect(new Tuple2<>(key.toString(), avg));
//        //            }
//        //        });
//        //d1.print();
//
...
//
//        // 并行度为 2 时窗口统计的结果
//        //线程号：69 | 事件时间：2019-03-01 13:08:01.677 | 消息：我第一个窗口输出 | 水印日期：2019-03-01 13:08:00.677
//        //线程号：68 | 事件时间：2019-03-01 13:08:05.677 | 消息：是 | 水印日期：2019-03-01 13:08:04.677
//        //线程号：69 | 事件时间：2019-03-01 13:08:04.586 | 消息：你 | 水印日期：2019-03-01 13:08:03.586
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:00.000 | 窗口关闭：2019-03-01 13:08:03.000 | 主题：test 日期：2019-03-01 13:08:01.6770 毫秒：1551416881677 消息：我第一个窗口输出
//        //线程号：68 | 事件时间：2019-03-01 13:08:08.683 | 消息：子 | 水印日期：2019-03-01 13:08:07.683
//        //线程号：69 | 事件时间：2019-03-01 13:08:07.680 | 消息：儿 | 水印日期：2019-03-01 13:08:06.680
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:03.000 | 窗口关闭：2019-03-01 13:08:06.000 | 主题：test 日期：2019-03-01 13:08:04.5860 毫秒：1551416884586 消息：你
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:03.000 | 窗口关闭：2019-03-01 13:08:06.000 | 主题：test 日期：2019-03-01 13:08:05.6770 毫秒：1551416885677 消息：是
//        //线程号：68 | 事件时间：2019-03-01 13:08:06.679 | 消息：我 | 水印日期：2019-03-01 13:08:05.679
//        //线程号：69 | 事件时间：2019-06-02 03:21:26.679 | 消息：测 | 水印日期：2019-06-02 03:21:25.679
//        //线程号：68 | 事件时间：2019-09-25 21:08:06.679 | 消息：试 | 水印日期：2019-09-25 21:08:05.679
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:06.000 | 窗口关闭：2019-03-01 13:08:09.000 | 主题：test 日期：2019-03-01 13:08:06.6790 毫秒：1551416886679 消息：我
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:06.000 | 窗口关闭：2019-03-01 13:08:09.000 | 主题：test 日期：2019-03-01 13:08:07.6800 毫秒：1551416887680 消息：儿
//        //2> 结果输出 -> 线程号：71 窗口开启：2019-03-01 13:08:06.000 | 窗口关闭：2019-03-01 13:08:09.000 | 主题：test 日期：2019-03-01 13:08:08.6830 毫秒：1551416888683 消息：子
//
//        environment.execute();
//    }
//}
